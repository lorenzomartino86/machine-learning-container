FROM python:latest
RUN pip install flask jupyter numpy pandas scikit-learn pandas-datareader wtforms scipy matplotlib seaborn sqlalchemy lxml html5lib BeautifulSoup4 plotly cufflinks scipy pydot tensorflow
